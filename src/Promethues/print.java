...
public print(String sub, String pay, String bal, TableModel tableModel) throws PrinterException {
  ...
  txtprint.setText("*******************************************************\n");
txtprint.setText(txtprint.getText() + "*****************C-MOS Computers*****************\n");
txtprint.setText(txtprint.getText() + "Date & Time: " + dateTime + "\n");
txtprint.setText(txtprint.getText() + "\n");

// Print column headers with formatted spacing
txtprint.setText(txtprint.getText() + String.format("%-25s %-10s %-10s\n", "Product", "Price", "Total"));
txtprint.setText(txtprint.getText() + "---------------------------------------------------------------\n");

// Print each product row with formatted spacing
for (int i = 0; i < tableModel.getRowCount(); i++) {
    ...
    // Align product name, price, and total
    txtprint.setText(txtprint.getText() + String.format("%-25s %-10s %-10d\n", product, price, total));
}

txtprint.setText(txtprint.getText() + "\n");
txtprint.setText(txtprint.getText() + String.format("%-35s %s\n", "Subtotal:", sub));
txtprint.setText(txtprint.getText() + String.format("%-35s %s\n", "Pay:", pay));
txtprint.setText(txtprint.getText() + String.format("%-35s %s\n", "Balance:", bal));
